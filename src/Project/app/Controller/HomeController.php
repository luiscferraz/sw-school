 ...
 class HomeController extends AppController{
        ...
        public function index () {
			   ...
			   $this-> set ('nome_usuario',$this->Auth->user('username'));		
				...
				$consultor1PadraoId = $this->Home->Activity->query('select activities.project_id, activities.start_hours, activities.end_hours, activities.date, activities.removed, consultants.name, consultants.acronym, consultants.acronym_color from consultants, activities where activities.status = "Planejada" and activities.consultant1_id = consultants.id and activities.consultant1_id is not null');			
