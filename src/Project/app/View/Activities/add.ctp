    ...
    <div id="content">
        ...
        echo $this->Form->create('Activities', array('action' => 'add/'.$id)); ?>
            <fieldset id="Dados_projeto_pai">
                ...
                <?php echo $this->Form->input('Activity.consultant1_id', array('options' => $list_consultants,'empty' => 'Selecione', 'type'=>'select','label' => 'Consultor 1: ', 'id'=>'actvID','class'=>'cosultant-atividade', 'required' => 'required')); ?>
