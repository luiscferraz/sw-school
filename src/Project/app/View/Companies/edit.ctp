...
<div class="companies form">
    ...
    <div class="right">
		...
		<fieldset id="contato">
			...
			<?php
				echo $this->Form->input('Contact1.id', array('type' => 'hidden')); 
			...
			<hr>
			<?php
				echo $this->Form->input('Contact2.id', array('type' => 'hidden')); 
		...
		<fieldset id="contato2">
			<legend class="legenda">Contatos</legend>
			<?php
				echo $this->Form->input('Contact3.id', array('type' => 'hidden')); 
			...
			<hr>
			<?php
				echo $this->Form->input('Contact4.id', array('type' => 'hidden')); 
