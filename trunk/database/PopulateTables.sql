...
INSERT INTO `swsdb`.`projects` (`id`, `name`, `description`, `acronym`, `a_hours_individual`, `b_hours_individual`, `c_hours_individual`, `a_hours_group`, `b_hours_group`, `c_hours_group`, `consultant_id`, `parent_project_id`, `company_id`, `removed`) VALUES (NULL, 'Sistema de Hotel', 'Controle de hotéis', 'SH', '10', '10', '10', '20', '20', '20', '1', NULL, '1', '');
INSERT INTO `swsdb`.`projects` (`id`, `name`, `description`, `acronym`, `a_hours_individual`, `b_hours_individual`, `c_hours_individual`, `a_hours_group`, `b_hours_group`, `c_hours_group`, `consultant_id`, `parent_project_id`, `company_id`, `removed`) VALUES (NULL, 'Controle de lanchonete', 'Auxilar nas vendas', 'CL', '15', '10', '18', '10', '7', '30', '3', NULL, '4', '');
INSERT INTO `swsdb`.`projects` (`id`, `name`, `description`, `acronym`, `a_hours_individual`, `b_hours_individual`, `c_hours_individual`, `a_hours_group`, `b_hours_group`, `c_hours_group`, `consultant_id`, `parent_project_id`, `company_id`, `removed`) VALUES (NULL, 'Sistema de estoque', 'Controlar o estoque', 'SE', '3', '3', '3', '10', '5', '5', '5', '2', '5', '');
