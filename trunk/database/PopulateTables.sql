...
INSERT INTO `swsdb`.`projects` (`id`, `name`, `description`, `acronym`, `a_hours_individual`, `b_hours_individual`, `c_hours_individual`, `a_hours_group`, `b_hours_group`, `c_hours_group`, `consultant_id`, `parent_project_id`, `company_id`, `removed`) VALUES (NULL, 'Sistema de Hotel', 'Controle de hotéis', 'SH', '10', '10', '10', '20', '20', '20', '1', NULL, '1', '0');
...
(1, '10/01/2013', 'A', 10, 'A qualidade estava excelente', 2, 1, 0, 0),
(2, '19/01/2013', 'C', 5, 'Apos estudo foi atestado que o custo ficaria muito alto para a distancia entre os pontos, o melhor seria utilizar cabo utp', 3, 2, 0, 0);