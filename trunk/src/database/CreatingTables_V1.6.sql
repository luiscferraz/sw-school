...
/*Chave estrangeira para ligar a tabela consultants_bank_info a tabela consultants*/
...
create table companies_contacts (name varchar (50),
				 email varchar (20),
				 function varchar (25),
...
/*Adicionar campo data a tabela companies*/
