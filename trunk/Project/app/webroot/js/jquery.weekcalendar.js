...
(function($) {
	...
	return {
		...
		editable: function(calEvent, element) {
		    return true;
		},
       ...
       */
        ...
        */
		...
		$weekDayColumns.each(function(i, val) {
		    if (!options.readonly && options.droppable($(this))) {
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
	...
	$calEvent.css({
	    top: pxTop,
	    height: pxHeight || (pxPerMillis * 3600000 / options.timeslotsPerHour)
	    });
    },
