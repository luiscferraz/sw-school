 ...
 */
 ...
 class ConsultantsController extends AppController {
 	...
 	public function view($id = null){
        ...
        $this ->set('projects', $this->Consultant->ProjectConsultant->query('SELECT projects.name, projects.description, projects.acronym FROM projects, project_consultants, consultants WHERE project_consultants.consultant_id = .$id. AND project_consultants.project_id = projects.id'));
